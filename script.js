const translations = {
    en: {
        ...
        default_insurance: "Default: Based on $2,325 per year for $300k home value in FL",
        years_30: "30 Years",
        years_20: "20 Years",
        years_15: "15 Years",
        years_10: "10 Years",
        ...
        monthly_costs: "Monthly Costs",
        extra_payment_details: "Extra Payment Details",
        upfront_costs: "Upfront Costs",
        affordability_analysis: "Affordability Analysis",
        first_time_buyer_resources: "First-Time Buyer Resources",
        loan_amount: "Loan Amount",
        ...
        hoa_cdd: "HOA/CDD Fees",
        standard: "Standard Payment",
        extra_payments: "Extra Payments",
        down_payment: "Down Payment",
        closing_costs: "Closing Costs",
        max_home_price: "Max Home Price",
        input_home_price: "Input Home Price",
        fha_grant_savings: "FHA Grant Savings",
    ...
    es: {
        ...
        default_insurance: "Predeterminado: Basado en $2,325 por año para una vivienda de $300k",
        years_30: "30 Años",
        years_20: "20 Años",
        years_15: "15 Años",
        years_10: "10 Años",
        ...
        monthly_costs: "Costos Mensuales",
        principal_interest: "Principal e Interés",
        property_taxes: "Impuestos de Propiedad",
        homeowners_insurance: "Seguro de Vivienda",
        hoa_fees: "Cuotas de HOA",
        private_mortgage_insurance: "Seguro Hipotecario Privado",
        mortgage_insurance_premium: "Prima de Seguro Hipotecario",
        total_monthly_payment: "Pago Mensual Total",
        with_extra_payment: "Con Pago Extra",
        extra_payment_details: "Detalles de Pago Extra",
        loan_term_extra_payments: "Plazo del Préstamo con Pagos Extra",
        years_saved_extra_payments: "Años Ahorrados con Pagos Extra",
        upfront_costs: "Costos Iniciales",
        down_payment: "Pago Inicial",
        closing_costs: "Costos de Cierre",
        total_upfront_costs: "Costos Iniciales Totales",
        ...
        years: "Años",
        months: "meses",
        affordability_analysis: "Análisis de Asequibilidad",
        max_home_price: "Precio Máximo de Vivienda",
        recommended_monthly_payment: "Pago Mensual Recomendado",
        debt_to_income_ratio: "Relación Deuda-Ingresos",
        first_time_buyer_savings: "Ahorros para Compradores Primerizos",
        estimated_grant: "Subvención Estimada",
        remaining_costs: "Costos Restantes"
    },
    zh: {
        title: "终极房地产计算器",
        ...
        default_insurance: "默认：基于30万美元房产每年2325美元的保险费用",
        years_30: "30年",
        years_20: "20年",
        years_15: "15年",
        years_10: "10年",
    ...
    ar: {
        ...
        default_insurance: "الافتراضي: بناءً على 2,325$ سنويًا لمنزل بقيمة 300 ألف دولار",
        years_30: "30 سنة",
        years_20: "20 سنة",
        years_15: "15 سنة",
        years_10: "10 سنوات",
    ...
    ru: {
        ...
        default_insurance: "По умолчанию: На основе $2,325 в год для дома стоимостью $300k",
        years_30: "30 Лет",
        years_20: "20 Лет",
        years_15: "15 Лет",
        years_10: "10 лет",
    ...
    pt: {
        ...
        default_insurance: "Padrão: Baseado em $2.325 por ano para imóvel de $300k",
        years_30: "30 Anos",
        years_20: "20 Anos",
        years_15: "15 Anos",
        years_10: "10 Anos",
    ...
    fr: {
        ...
        default_insurance: "Par défaut: Basé sur 2 325$ par an pour un logement de 300k$",
        years_30: "30 Ans",
        years_20: "20 Ans",
        years_15: "15 Ans",
        years_10: "10 Ans",
    ...
    it: {
        ...
        default_insurance: "Predefinito: Basato su $2,325 all'anno per casa da $300k",
        years_30: "30 Anni",
        years_20: "20 Anni",
        years_15: "15 Anni",
        years_10: "10 Anni",
    ...
    de: {
        ...
        default_insurance: "Standard: Basierend auf $2.325 pro Jahr für ein $300k-Haus",
        years_30: "30 Jahre",
        years_20: "20 Jahre",
        years_15: "15 Jahre",
        years_10: "10 Jahre",
    ...
    ja: {
        ...
        default_insurance: "デフォルト：30万ドル住宅で年間$2,325を基準",
        years_30: "30年",
        years_20: "20年",
        years_15: "15年",
        years_10: "10年",
    ...
    sv: {
        ...
        default_insurance: "Standard: Baserat på $2 325 per år för hem värda $300k",
        years_30: "30 År",
        years_20: "20 År",
        years_15: "15 År",
        years_10: "10 År",
    ...
    ko: {
        ...
        default_insurance: "기본값: $300k 주택 기준 연간 $2,325",
        years_30: "30년",
        years_20: "20년",
        years_15: "15년",
        years_10: "10년",
...
// Helper function to insert chart containers into the DOM
function insertChartContainers() {
    // Insert chart container inside loan summary section
    const loanSummarySection = document.querySelector('.loan-summary-results');
    if (loanSummarySection && !document.getElementById('loanSummaryChart')) {
        const loanSummaryChartContainer = document.createElement('div');
        loanSummaryChartContainer.className = 'chart-container';
        loanSummaryChartContainer.innerHTML = '<canvas id="loanSummaryChart"></canvas>';
        loanSummarySection.appendChild(loanSummaryChartContainer);
    }
    
    // Insert chart container inside monthly costs section
    const monthlyCostsSection = document.querySelector('.monthly-costs-section');
    if (monthlyCostsSection && !document.getElementById('monthlyCostsChart')) {
        const monthlyCostsChartContainer = document.createElement('div');
        monthlyCostsChartContainer.className = 'chart-container';
        monthlyCostsChartContainer.innerHTML = '<canvas id="monthlyCostsChart"></canvas>';
        monthlyCostsSection.appendChild(monthlyCostsChartContainer);
    }
    
    // Insert chart container inside extra payment section (if it exists)
    const extraPaymentSection = document.querySelector('.extra-payment-section');
    if (extraPaymentSection && !document.getElementById('extraPaymentChart')) {
        const extraPaymentChartContainer = document.createElement('div');
        extraPaymentChartContainer.className = 'chart-container';
        extraPaymentChartContainer.innerHTML = '<canvas id="extraPaymentChart"></canvas>';
        extraPaymentSection.appendChild(extraPaymentChartContainer);
    }
    
    // Insert chart container inside upfront costs section
    const upfrontCostsSection = document.querySelector('.upfront-costs-section');
    if (upfrontCostsSection && !document.getElementById('upfrontCostsChart')) {
        const upfrontCostsChartContainer = document.createElement('div');
        upfrontCostsChartContainer.className = 'chart-container';
        upfrontCostsChartContainer.innerHTML = '<canvas id="upfrontCostsChart"></canvas>';
        upfrontCostsSection.appendChild(upfrontCostsChartContainer);
    }
    
    // Insert chart container inside affordability section (if it exists)
    const affordabilitySection = document.querySelector('.affordability-results');
    if (affordabilitySection && !document.getElementById('affordabilityChart')) {
        const affordabilityChartContainer = document.createElement('div');
        affordabilityChartContainer.className = 'chart-container';
        affordabilityChartContainer.innerHTML = '<canvas id="affordabilityChart"></canvas>';
        affordabilitySection.appendChild(affordabilityChartContainer);
    }
    
    // Insert chart container inside first-time buyer resources section
    const firstTimeBuyerSection = document.querySelector('.first-time-buyer-resources');
    if (firstTimeBuyerSection && !document.getElementById('firstTimeBuyerChart')) {
        const firstTimeBuyerChartContainer = document.createElement('div');
        firstTimeBuyerChartContainer.className = 'chart-container';
        firstTimeBuyerChartContainer.innerHTML = '<canvas id="firstTimeBuyerChart"></canvas>';
        firstTimeBuyerSection.appendChild(firstTimeBuyerChartContainer);
    }
}

// Helper function to create and render charts for the buyer calculator
function createBuyerChart(chartType, chartId, labels, data, options = {}) {
    ...
    // Use consistent white text styling for all charts
    const isDarkMode = true; // Always use dark mode styling for charts
    
    // Set text colors to white/light for all charts
        ...
        plugins: {
            legend: {
                ...
                labels: {
                    ...
                    // Add text shadow to ensure visibility on any background
    ...
    // For pie and doughnut charts, set text color for all labels
    if (chartType === 'pie' || chartType === 'doughnut') {
        if (!chartOptions.plugins) chartOptions.plugins = {};
        if (!chartOptions.plugins.datalabels) chartOptions.plugins.datalabels = {};
        chartOptions.plugins.datalabels.color = textColor;
    }
...
async function calculateBuyer() {
    try {
        ...
        insertChartContainers();
        
        // Render all charts
        // 1. Loan Summary Chart
        createBuyerChart('bar', 'loanSummaryChart', 
            [translations[lang].home_price || 'Home Price', translations[lang].loan_amount || 'Loan Amount'],
            [{
                label: translations[lang].loan_summary || 'Loan Summary',
                data: [price, loan],
        ...
        const monthlyLabels = [translations[lang].principal_interest || 'Principal & Interest'];
        const monthlyData = [principalInterest];
        
        if (monthlyPMI > 0) {
            monthlyLabels.push(loanType === 'fha' ? 
                (translations[lang].mortgage_insurance_premium || 'Mortgage Insurance Premium') : 
                (translations[lang].private_mortgage_insurance || 'Private Mortgage Insurance'));
            monthlyData.push(monthlyPMI);
        }
        
        if (includeEscrow) {
            monthlyLabels.push(translations[lang].property_taxes || 'Property Taxes');
            monthlyData.push(monthlyPropertyTax);
            
            monthlyLabels.push(translations[lang].homeowners_insurance || 'Homeowners Insurance');
            monthlyData.push(monthlyInsurance);
            
            if (hoaFees > 0) {
                monthlyLabels.push(translations[lang].hoa_fees || 'HOA Fees');
                monthlyData.push(hoaFees);
            }
            
            if (cddFees > 0) {
                monthlyLabels.push(translations[lang].buyer_cdd || 'CDD Fees');
                monthlyData.push(cddFees);
            }
        }
        
        // Calculate total for percentages
        const monthlyTotal = monthlyData.reduce((sum, value) => sum + value, 0);
        
        createBuyerChart('pie', 'monthlyCostsChart', 
            monthlyLabels,
            [{
                data: monthlyData,
                backgroundColor: [
                    '#4e73df', // Principal & Interest
                    '#1cc88a', // Property Tax
                    '#36b9cc', // Insurance
                    '#f6c23e', // PMI
                    '#e74a3b', // HOA
                    '#6f42c1'  // Extra Payment
                ],
                borderColor: [
                    '#2e59d9', // Principal & Interest
                    '#17a673', // Property Tax
                    '#2c9faf', // Insurance
                    '#f4b619', // PMI
                    '#e02d1b', // HOA
                    '#5a32a3'  // Extra Payment
                ],
                borderWidth: 2
            }],
            {
                ...
                plugins: {
                    legend: {
                        ...
                        labels: {
                            ...
                            padding: 20, // Increased padding between legend items
                            boxWidth: 10,
                            usePointStyle: true,
                            pointStyle: 'circle'
                        },
                        maxHeight: 100 // Increased height for legend
                    },
                    tooltip: {
                        callbacks: {
                    ...
                    datalabels: {
                        ...
                        formatter: (value, ctx) => {
                            const percentage = ((value / monthlyTotal) * 100).toFixed(0);
                            return percentage + '%';
                        },
                        // Show percentage on all slices
                        display: true,
                        // Keep all labels centered in slices
                        anchor: 'center',
                        align: 'center',
                        offset: 0
                    }
                },
                cutout: '0%', // Remove the center hole completely
                radius: '100%' // Make the pie chart as large as possible
            }
        );
        
        // 3. Extra Payment Chart (if applicable)
        if (extraPayment > 0) {
            // Generate amortization data for standard and accelerated payment schedules
            const standardAmortization = [];
            const acceleratedAmortization = [];
            
            let standardBalance = loan;
            let acceleratedBalance = loan;
            const yearLabels = [];
            
            // Calculate balance at yearly intervals
            for (let year = 0; year <= term; year++) {
                yearLabels.push(year);
                
                // Add initial loan amount for year 0
                if (year === 0) {
                    standardAmortization.push(loan);
                    acceleratedAmortization.push(loan);
                    continue;
                }
                
                // Calculate standard amortization for this year
                let monthlyRate = rate / 100 / 12;
                let monthlyPayment = principalInterest;
                
                for (let month = 1; month <= 12; month++) {
                    if ((year - 1) * 12 + month > months) break;
                    
                    let interestPayment = standardBalance * monthlyRate;
                ...
                // Calculate accelerated amortization for this year
                monthlyPayment = principalInterest + extraPayment;
                
                for (let month = 1; month <= 12; month++) {
                    if (acceleratedBalance <= 0) break;
                    
                    let interestPayment = acceleratedBalance * monthlyRate;
                    let principalPayment = monthlyPayment - interestPayment;
                ...
                standardAmortization.push(Math.max(0, standardBalance));
                acceleratedAmortization.push(Math.max(0, acceleratedBalance));
            }
            
            createBuyerChart('line', 'extraPaymentChart', 
                yearLabels,
                [
                    {
                        label: translations[lang].standard_payment || 'Standard Payment',
                        data: standardAmortization,
                    ...
                    {
                        label: translations[lang].with_extra_payment || 'With Extra Payment',
                        data: acceleratedAmortization,
                ...
                ],
                {
                    layout: {
                        padding: {
                            left: 5,  // Reduced left padding to move chart to the left
                            right: 30, // Increased right padding to balance
                            top: 35,  // Much more top padding for the y-axis label
                            bottom: 15
                        }
                    },
                    scales: {
                        y: {
                            ...
                            title: {
                                display: true,
                                text: 'Loan Balance', // Back to single line but with more space
                                color: '#ffffff',
                                font: {
                                    weight: 'bold',
                                    size: 13  // Larger font
                                ...
                                padding: { 
                                    top: 20,  // Add significant top padding
                                    bottom: 20,  // Add significant bottom padding
                                    left: 0,
                                    right: 25  // Much more space for the title
                                },
                                position: 'top', // Move the title to the top of the axis instead of side
                                align: 'center' // Center align the title
                            },
                            ticks: {
                                color: '#e0e0e0',
                                padding: 8  // Add more padding to ticks
                            },
                            grid: {
                        ...
                        x: {
                            title: {
                                display: true,
                                text: translations[lang].years || 'Years',
                                color: '#ffffff',
                                font: {
                                    weight: 'bold'
                                }
        ...
        // 4. Upfront Costs Chart
        createBuyerChart('bar', 'upfrontCostsChart', 
            [translations[lang].down_payment || 'Down Payment', translations[lang].closing_costs || 'Closing Costs'],
            [{
                label: translations[lang].upfront_costs || 'Upfront Costs',
                data: [down, closingCosts],
        ...
        // 5. Affordability Analysis Chart (if applicable)
        if (affordabilityEnabled && affordabilityResults) {
            createBuyerChart('bar', 'affordabilityChart', 
                [translations[lang].max_home_price || 'Maximum Home Price', translations[lang].home_price || 'Your Home Price'],
                [{
                    label: translations[lang].affordability_analysis || 'Affordability Analysis',
                    data: [affordabilityResults.homePrice, price],
        ...
        // 6. First-Time Buyer Resources Chart
        // Check if the first-time buyer checkbox is checked
        const isFirstTimeBuyer = document.getElementById('first-time-buyer')?.checked || false;
        
        if (isFirstTimeBuyer) {
            // Estimate FHA grant savings (approximately 3% of home price)
            const estimatedGrant = price * 0.03;
            
            createBuyerChart('doughnut', 'firstTimeBuyerChart', 
                [translations[lang].estimated_grant || 'Estimated Grant', translations[lang].remaining_costs || 'Remaining Costs'],
                [{
                    data: [estimatedGrant, totalUpfrontCosts - estimatedGrant],
                ...
                }],
                {
                    plugins: {
                        title: {
                            display: true,
                            text: translations[lang].first_time_buyer_savings || 'First-Time Buyer Potential Savings',
                            font: {
                                size: 12
                            }
                        }
            ...
            // If not a first-time buyer, hide the chart container
            const firstTimeBuyerChartContainer = document.getElementById('firstTimeBuyerChart').parentElement;
            if (firstTimeBuyerChartContainer) {
                firstTimeBuyerChartContainer.style.display = 'none';
            }
        }
